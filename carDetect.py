...
# path = "D:/Data/Image/beijing_bohaidongdt24-night/railpic/"
# imagepath2 = path + "beijing_bohaidongdt24_00031.jpg"
...
for dir in dir_list:
    ...
    for i in range(0, length - 1):
        ...
        cv2.imwrite(dist_dir + '/' + 'sub' + file_list[i], binary)
        ...
        cv2.imwrite(dist_dir + '/' + file_list[i], cropImage1)
        count = len(contours)
        num.append(count)
